...
public:
	...
	{
		return driver->read<std::uintptr_t>(reinterpret_cast<std::uintptr_t>(this) + Classes::TOD_Rays::godRayMaterial);
	}
};
...
{
public:
	auto get_rays() -> c_tod_rays*
	{
		return driver->read<c_tod_rays*>(reinterpret_cast<std::uintptr_t>(this) + Classes::TOD_Components::Rays);
	}
};
