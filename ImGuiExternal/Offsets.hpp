...
offset( OcclusionCulling_c, 48995488); // OcclusionCulling_c* Updates 1/13/2023
offset( tod_sky_c, 48694712); // tod_sky_c* Updates 1/13/2023
offset( ConVar_Culling_c, 48640960); // ConVar_Culling_c* Updates 1/13/2023
offset( flashbangoverlay_c, 48735808); // flashbangoverlay_c* Updates 1/13/2023
offset( convar_admin_c, 49062152); // convar_admin_c* Updates 1/13/2023
offset( localplayer_c, 48918992); // localplayer_c* Updates 1/13/2023
offset( convar_graphics_c, 48764840); // convar_graphics_c* Updates 1/13/2023
offset( BaseEntity_c, 48797344); // System_Collections_Generic_List_BaseGameMode__c* Updates 1/13/2023
offset( ConVar_Client_c, 48611392); // ConVar_Client_c* Updates 1/13/2023
offset( Skinnable_c, 48633768); // Skinnable_c* Updates 1/13/2023
offset( Maincamera_c, 48552856); // Maincamera_c*   Updates 1/13/2023
offset(BasePlayer_c, 48552856); //BasePlayer_c*
namespace Offsets
{
	namespace Classes
	{
		...
		{
			constexpr auto bodyRotation= 0x2C; // private Quaternion bodyRotation; // 0x2C
			constexpr auto headRotation= 0x48; // private Quaternion headRotation; // 0x48
			...
			constexpr auto movement = 0x4d0; // BaseMovement
			...
			constexpr auto clActiveItem = 0x5d0; // uint
			...
			constexpr auto playerFlags = 0x688; // BasePlayer.PlayerFlags
			constexpr auto eyes = 0x698; // PlayerEyes
			constexpr auto inventory = 0x698; // PlayerInventory
		...
		namespace BaseProjectile
		{
			...
			constexpr auto isReloading = 0x364; // bool
		...
		namespace TOD_Rays
		{
		    constexpr auto GodRayShader = 0x30; // Shader
			constexpr auto ScreenClearShader = 0x38; // Shader
			constexpr auto SkyMaskShader = 0x40; // Shader
			constexpr auto UseDepthTexture = 0x48; // bool
			constexpr auto BlendMode = 0x4c; // TOD_Rays.BlendModeType
			constexpr auto Intensity = 0x50; // float
			constexpr auto Resolution = 0x54; // TOD_ImageEffect.ResolutionType
			constexpr auto BlurIterations = 0x58; // int
			constexpr auto BlurRadius = 0x5c; // float
			constexpr auto MaxRadius = 0x60; // float
			constexpr auto godRayMaterial = 0x68; // Material
			constexpr auto screenClearMaterial = 0x70; // Material
			constexpr auto skyMaskMaterial = 0x78; // Material
		}
		namespace TOD_Components
		{
			...
			constexpr auto Rays = 0x198; // backing field
		}
		//updated
